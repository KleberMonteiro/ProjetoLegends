...
import com.projeto.service.rest.impl.LolStaticDataRESTImpl;
import com.projeto.service.rest.impl.SummonerRESTImpl;

public class TesteRESTCliente {

	public static void main(String[] args) {
		HashMap<String, SummonerDto> summonerResponse = new SummonerRESTImpl().searchSummonesrByNames("schaka");
